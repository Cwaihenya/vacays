...
class PlacesTest < ApplicationSystemTestCase
  ...
  test "creating a Place" do
    ...
    fill_in "Building age", with: @place.building_age
    fill_in "Property name", with: @place.property_name
    fill_in "Remarks", with: @place.remarks
    fill_in "Rent", with: @place.rent
