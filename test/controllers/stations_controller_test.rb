...
class StationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create station" do
    assert_difference('Station.count') do
      post stations_url, params: { station: { how_many_mins_walk: @station.how_many_mins_walk, name_of_railway_line: @station.name_of_railway_line, place_id: @station.place_id, station_name: @station.station_name } }
    end
  ...
  test "should update station" do
    patch station_url(@station), params: { station: { how_many_mins_walk: @station.how_many_mins_walk, name_of_railway_line: @station.name_of_railway_line, place_id: @station.place_id, station_name: @station.station_name } }
